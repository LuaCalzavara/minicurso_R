...
```{r}
export("C:\\Users\\Lua\\Downloads\\base_final.csv", base_municipio) #São dois argumento: 1. o caminho de destino da base com o nome que eu quero exportar + o tipo (.csv); 2. o objeto
```

mas se eu quero exportar para a pasta onde está o script:
```{r}
export("base_final.csv", base_municipio)
```
